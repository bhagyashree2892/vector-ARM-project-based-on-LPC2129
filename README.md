...
Select the LPC2129 device.
Add all required ".c" files.
Add the required header files.
Build the project.
Program the LPC2129 using Flash Magic.
Test the RFID, keypad, PIR, RTC, EEPROM, door sensor and access-control functions.
Features
RFID authentication
